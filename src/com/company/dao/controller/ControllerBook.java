        ...
        try (DataSource dataSource = new DataSource()) {
            ...
            while (exit) {
                ...
                if (commandConsole.matches("all")) {
                    ...
                    if (matcher.find()) {
                        bookService.deleteBookById(Long.parseLong(matcher.group()));
                    }
                    ...
                    if (matcher.find()) {
                        bookService.getBookByISBN(matcher.group());
                    }
                    ...
                    if (matcher.find()) {
                        bookService.getBookByAuthor(matcher.group(1));
                    }
                } else if (commandConsole.matches("countallbooks")) {
                    bookService.countAllBooks();
                }
            }
        } catch (
                Exception e) {
